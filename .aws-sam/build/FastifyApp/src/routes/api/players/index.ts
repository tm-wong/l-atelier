...
const playersRoutes: FastifyPluginAsync = async(
    ...
    fastify.addHook('onRequest', async(request, reply) => {
        const authorized = await fastify.authorize(request, reply);
        if (!authorized) {
     ...
     *      curl -i \
     *      -H "Authorization: Bearer $TOKEN" \
     *      https://ysu0trifbg.execute-api.us-east-1.amazonaws.com/api/players/95
     *
     *
     * @apiSuccessExample {json} 200 OK
     *
     ...
     *      curl -i \
     *      -H "Authorization: Bearer $TOKEN" \
     *      https://ysu0trifbg.execute-api.us-east-1.amazonaws.com/api/players/kpis
     *
     *
     * @apiSuccessExample {json} 200 OK
     *
