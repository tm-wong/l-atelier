...
export default class PlayerRepository extends Repository {
    ...
    constructor(fastify: FastifyInstance) {
        super(fastify);
        this.log = fastify.appLog('PLAYERS_REPOSITORY');
    }


    async get(): Promise<pg.QueryResultRow> {
    ...
    async getOne(id: number): Promise<pg.QueryResultRow> {
    ...
    async kpis(): Promise<pg.QueryResultRow> {
